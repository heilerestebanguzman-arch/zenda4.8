...
export const DocumentCapture: React.FC<DocumentCaptureProps> = ({
  ...
  const confirmDocument = async () => {
    if (capturedImage) {
      try {
        const fileName = `ci_${side}_${Date.now()}.jpg`;
      ...
      {capturedImage ? (
        <View style={styles.previewContainer}>
          ...
          <View style={styles.previewButtons}>
            ...
            <TouchableOpacity style={styles.confirmBtn} onPress={confirmDocument}>
          ...
          <View style={styles.overlay}>
            <View style={styles.overlayFrame}>
              <Text style={styles.overlayText}>
                Coloca tu {side === 'front' ? 'anverso' : 'reverso'} del Carnet dentro del marco
              </Text>
            </View>
          </View>
